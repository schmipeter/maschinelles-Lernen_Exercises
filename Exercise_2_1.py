...
# Fazit:
# LDA trennt lineare Klassen sehr gut, wenn sich die Klassen durch Mittelwert und Kovarianz unterscheiden.
# Im Toy-Beispiel gelingt die Trennung trotz Ellipsenform, da die Klassen linear separierbar sind.
# Bei Iris (Versicolor vs. Virginica) erreicht LDA gute Genauigkeit, auch mit nur zwei Merkmalen.
# LDA ist effizient und robust bei niedrigdimensionalen linearen Entscheidungsgrenzen.
