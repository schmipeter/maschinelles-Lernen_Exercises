...
plt.figure(figsize=(6, 5))
plt.scatter(
    X_iris_pca[:, 0], X_iris_pca[:, 1], c=labels_iris, cmap="viridis", edgecolor="k"
)
...
bgmm_moons = BayesianGaussianMixture(
    n_components=10, covariance_type="full", random_state=42
)
...
# Fazit:
# -GMM liefert sehr gute Ergebnisse bei klar getrennten, normalverteilten Clustern (Toy, Iris).
# -Bei komplexeren Formen wie im Moons-Datensatz versagt klassisches GMM wegen der Modellannahmen.
# -Bayesian GMM erkennt flexibler auch kleinere oder zusätzliche Cluster.
# -Für nicht-gaussförmige Daten sind Alternativen wie DBSCAN oder Spectral Clustering besser geeignet.
