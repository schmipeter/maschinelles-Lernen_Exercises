...
ax1.arrow(
    mid_a[0],
    mid_a[1],
    w_unit_a[0] * arrow_scale,
    w_unit_a[1] * arrow_scale,
    color="m",
    head_width=0.2,
    head_length=0.3,
    label="Normal vector",
...
ax1.text(
    mid_a[0] + w_unit_a[0] * arrow_scale * 1.1,
    mid_a[1] + w_unit_a[1] * arrow_scale * 1.1,
    "w",
    color="m",
    fontsize=12,
)
...
ax2.arrow(
    mid_b[0],
    mid_b[1],
    w_unit_b[0] * arrow_scale,
    w_unit_b[1] * arrow_scale,
    color="m",
    head_width=0.2,
    head_length=0.3,
    label="Normal vector",
...
ax2.text(
    mid_b[0] + w_unit_b[0] * arrow_scale * 1.1,
    mid_b[1] + w_unit_b[1] * arrow_scale * 1.1,
    "w",
    color="m",
    fontsize=12,
)
...
# Fazit:
# Die beiden Figuren (2.7(a) und 2.7(b)) zeigen jeweils eine lineare Entscheidungsgrenze in 2D,
# die durch zwei Punkte definiert wird. Mithilfe des Normalenvektors w und des Offsets b
# lassen sich Punkte wie a und b klassifizieren, d.h. bestimmen, auf welcher Seite der Linie sie liegen.
# Die Darstellung zeigt anschaulich, wie der Vektor w senkrecht zur Linie steht und wie sich
# die Lage der Punkte a und b im Verhältnis zur Entscheidungsgrenze verändert,
# abhängig von der gewählten Linie. Dies ist zentral für lineare Klassifikatoren.
